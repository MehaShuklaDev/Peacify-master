...
@app.route('/books/surprise', methods = ['GET', 'POST'])
def booksSurprise():
    return render_template("booksSurprise.html")

@app.route('/movies/comedy', methods = ['GET', 'POST'])
def moviesComedy():
    return render_template("moviesComedy.html")

@app.route('/movies/romantic', methods = ['GET', 'POST'])
def moviesRomantic():
    return render_template("moviesRomantic.html")

@app.route('/movies/action', methods = ['GET', 'POST'])
def moviesAction():
    return render_template("moviesAction.html")


@app.route('/songs/romantic', methods = ['GET', 'POST'])
def songsRomantic():
    return render_template("songsRomantic.html")


@app.route('/books/romantic', methods = ['GET', 'POST'])
def booksRomantic():
    return render_template("booksRomantic.html")
